...
#ifndef ZIRCON_SYSTEM_HOST_FIDL_INCLUDE_FIDL_DDK_GENERATOR_H_
#define ZIRCON_SYSTEM_HOST_FIDL_INCLUDE_FIDL_DDK_GENERATOR_H_
...
#endif // ZIRCON_SYSTEM_HOST_FIDL_INCLUDE_FIDL_DDK_GENERATOR_H_
