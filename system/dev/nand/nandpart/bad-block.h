...
public:
    ...
    virtual zx_status_t GetBadBlockList(fbl::Array<uint32_t>* bad_blocks, uint32_t first_block,
                                        uint32_t last_block) { return ZX_ERR_NOT_SUPPORTED; }
    virtual zx_status_t IsBlockBad(uint32_t block, bool* is_bad) { return ZX_ERR_NOT_SUPPORTED; }
