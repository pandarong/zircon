...
// retrieves meta-data for a specific device
...
// adds meta-data to a specific device
zx_status_t device_add_metadata(zx_device_t* dev, uint32_t type, const void* data, size_t length);


// adds meta-data to be provided to future devices matching the specified topo path
