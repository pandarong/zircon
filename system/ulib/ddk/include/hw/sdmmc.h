...
#define SDMMC_RESP_R1b  (SDMMC_RESP_LEN_48B | SDMMC_RESP_CMD_IDX_CHECK | SDMMC_RESP_CRC_CHECK | SDMMC_RESP_BUSY)
...
#define SDMMC_READ_MULTIPLE_BLOCK_FLAGS     SDMMC_RESP_R1b | SDMMC_RESP_DATA_PRESENT | \
