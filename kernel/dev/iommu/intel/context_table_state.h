...
public:
    ...
    zx_status_t CreateDeviceContext(uint8_t bus, uint8_t dev_func, uint32_t domain_id,
                                    DeviceContext** context);

    zx_status_t GetDeviceContext(uint8_t bus, uint8_t dev_func, DeviceContext** context);
