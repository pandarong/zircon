...
static inline zx_status_t validate_resource_ioport(zx_handle_t handle, uintptr_t base, size_t len) {
...
static inline zx_status_t validate_resource_mmio(zx_handle_t handle, uintptr_t base, size_t len) {
