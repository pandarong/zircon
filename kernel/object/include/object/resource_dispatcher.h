...
public:
    ...
    static zx_status_t Create(ResourceDispatcher::RefPtr* dispatcher,
                              ...
                              RegionAllocator rallocs[ZX_RSRC_STATIC_COUNT] = static_rallocs_,
...
private:
    ...
    // flags for the resource. Currently only used for ZX_RSRC_FLAG_EXCLUSIVE
    ...
    static RegionAllocator static_rallocs_[ZX_RSRC_STATIC_COUNT] TA_GUARDED(resources_lock_);
