...
private:
    ...
    // The containing BTI holds a list of all its PMTs, even the quarantined
    // ones.
    ...
    fbl::DoublyLinkedListNodeState<fbl::RefPtr<PinnedMemoryTokenDispatcher>> dll_quarantine_;
